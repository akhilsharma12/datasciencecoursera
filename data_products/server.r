shinyServer(function(input, output, session) {
  ...
  getData <- function(inputPath="C:/Users/Administrator/Desktop/DS/data_products/",inputFile="mocRtnFile.csv",keepColumns=keepColumns) {
  ...
  data <- reactive({
    ...
    if (input$strategy == "ETF"){
      dt <- getData(inputPath="C:/Users/Administrator/Desktop/DS/data_products/",
                    inputFile="mocRtnFile.csv", keepColumns=c("date","rtn"))
